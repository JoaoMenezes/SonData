...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 310.0, 395.0, 350.0, 17.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "jmod.son.url.maxpat",
					"numinlets" : 1,
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 30.0, 237.0, 305.0, 112.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 325.5, 354.0, 650.5, 354.0 ],
					"source" : [ "obj-8", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 39.5, 345.5, 211.5, 345.5 ],
					"source" : [ "obj-8", 0 ]
				}
...
, 			{
				"name" : "jmod.son.url.maxpat",
				"bootpath" : "/Users/joaomenezes/Documents/SonData/Aquisition and Storage/jmod.son.url",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
