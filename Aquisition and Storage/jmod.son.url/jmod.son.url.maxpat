...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 936.0, 99.0, 50.0, 17.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "clear" ],
					"patching_rect" : [ 574.0, 213.0, 42.0, 19.0 ],
					"text" : "t clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 1145.5, 315.5, 492.0, 19.0 ],
					"text" : "jcom.message dump @type none @repetitions/allow 1 @description \"dump data (row-by-row)\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 900.0, 232.5, 32.5, 17.0 ],
					"text" : "edit"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 900.0, 264.0, 150.0, 55.0 ],
					"text" : "jcom.message edit @type string @repetitions/allow 1 @description \"edit dataset as text\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 858.0, 70.0, 187.0, 19.0 ],
					"text" : "route download edit clear directory"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 984.0, 177.0, 173.0, 55.0 ],
					"text" : "jcom.message defaultDir @type string @repetitions/allow 1 @description \"choose download folder\""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 490.0, 165.0, 34.0, 19.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 574.0, 153.0, 488.0, 19.0 ],
					"text" : "jcom.message download @type generic @repetitions/allow 1 @description \"bang to download\""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 50.0, 385.0, 22.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 574.0, 239.5, 240.0, 43.0 ],
					"text" : "jcom.message clear @type string @repetitions/allow 1 @description \"clear URL text field\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 50.0, 249.5, 56.0, 19.0 ],
					"text" : "jcom.in"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 50.0, 325.5, 67.0, 19.0 ],
					"text" : "jalg.son.url"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 13.0, 189.0, 247.0, 43.0 ],
					"text" : "jcom.hub @module_type control @description \"This module provides asynchronous file download. (http://; htps://; ftp://, file:/// )\"",
					"varname" : "jcom.hub"
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 499.5, 211.0, 556.0, 211.0, 556.0, 143.0, 583.5, 143.0 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 867.5, 136.0, 499.5, 136.0 ],
					"source" : [ "obj-22", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 951.5, 117.5, 583.5, 117.5 ],
					"source" : [ "obj-22", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 59.5, 297.0, 319.5, 297.0 ],
					"source" : [ "obj-24", 0 ]
				}
