...
, 			{
				"box" : 				{
					"args" : [ "@name", "jmod.son.mgraph", "@description", "a brief explanation" ],
					"bgmode" : 1,
					"id" : "obj-21",
					"maxclass" : "bpatcher",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 355.0, 74.0, 19.0 ],
					"text" : "loadmess set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 29.0, 375.0, 192.0, 17.0 ],
					"text" : "/module_name /template"
				}
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "jmod.son.mgraph.maxpat",
					"numinlets" : 2,
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 30.0, 237.0, 300.0, 105.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 39.5, 347.5, 211.5, 347.5 ],
					"source" : [ "obj-8", 0 ]
				}
...
, 			{
				"name" : "jmod.son.mgraph.maxpat",
				"bootpath" : "/Users/joaomenezes/Documents/SonData/Interaction/jmod.son.mgraph",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
