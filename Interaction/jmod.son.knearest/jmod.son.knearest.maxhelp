...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 530.0, 150.0, 94.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 175.0, 150.0, 359.0, 19.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "@name", "jmod.son.knearest", "@description", "a brief explanation" ],
					"bgmode" : 1,
					"id" : "obj-21",
					"maxclass" : "bpatcher",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 511.0, 74.0, 19.0 ],
					"text" : "loadmess set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 29.0, 531.0, 192.0, 17.0 ],
					"text" : "/module_name /knearest"
				}
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "jmod.son.knearest.maxpat",
					"numinlets" : 2,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 178.0, 303.0, 318.0 ],
...
,
					"patching_rect" : [ 410.0, 190.0, 172.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 150.0, 140.0, 19.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 39.5, 502.5, 211.5, 502.5 ],
					"source" : [ "obj-8", 0 ]
				}
...
, 			{
				"name" : "jmod.son.knearest.maxpat",
				"bootpath" : "/Users/joaomenezes/Documents/SonData/Interaction/jmod.son.knearest",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
