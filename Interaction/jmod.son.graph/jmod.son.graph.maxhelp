...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 25.0, 165.0, 165.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 25.0, 160.0, 390.0, 43.0 ],
					"text" : "\n \n- Jmod.son.Mgraph -> allows you to plot up to 5 dimensions (columns)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 364.0, 370.0, 95.0, 17.0 ],
					"text" : "/view/panel"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 475.0, 370.0, 66.0, 19.0 ],
					"text" : "Data out >"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 540.0, 370.0, 50.0, 17.0 ],
					"text" : "1.5"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 270.0, 210.0, 123.0, 18.0 ],
									"text" : "/myGraph/view/panel"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 50.0, 80.0, 57.0, 20.0 ],
									"text" : "t dump b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 200.0, 240.0, 182.0, 19.0 ],
...
, 							{
								"box" : 								{
									"coll_data" : 									{
										...
										"data" : [ 											{
												"key" : 0,
												"value" : [ "/myGraph/dataSetID", "/myTable" ]
											}
, 											{
												"key" : 1,
												"value" : [ "/myGraph/col", 2 ]
...
, 											{
												"key" : 2,
												"value" : [ "/myGraph/region", 0.06721, 48.659878 ]
											}
 ]
									}
,
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 200.0, 160.0, 91.0, 20.0 ],
									"saved_object_attributes" : 									{
										"embed" : 1
									}
,
									"text" : "coll graphState"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 50.0, 50.0, 63.0, 20.0 ],
									"text" : "delay 300"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 50.0, 20.0, 56.0, 19.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 279.5, 233.5, 209.5, 233.5 ],
									"source" : [ "obj-3", 0 ]
								}
...
,
					"patching_rect" : [ 40.0, 241.0, 70.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 40.0, 265.0, 300.0, 105.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 25.0, 90.0, 554.0, 55.0 ],
					"text" : "- jmod.son.graph allows you to plot and play one dimension of the dataset contained in a [jmod.son.table]\n\n- In the pannel window you can scrub the data, select a region to be played, and even, select the desired reproduction time.\n"
				}

			}
, 			{
				"box" : 				{
					"args" : [ "@name", "jmod.moduleName", "@description", "a line graph for interactive sonification" ],
					"bgmode" : 1,
					"id" : "obj-21",
					"maxclass" : "bpatcher",
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 0.0, 0.0, 661.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "jmod.son.graph.maxpat",
					"numinlets" : 1,
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 440.0, 250.0, 150.0, 105.0 ],
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "jmod.son.graph.maxpat",
				"bootpath" : "/Users/JoaoMenezes/Documents/_work/Max/SonData_Dev/_SonData/_Interaction/jmod.son.graph",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
