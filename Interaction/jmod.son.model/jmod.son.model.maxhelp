...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 333.875, 90.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "1",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
					"textovercolor" : [ 0.2, 0.2, 0.2, 1.0 ]
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 333.875, 110.0, 133.0, 40.0 ],
					"text" : "Import a dataset and give it a name"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 960.0, 531.0, 150.0, 37.0 ],
					"text" : "position & rotation as an FTM matrix"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1120.0, 511.0, 41.355469, 18.0 ],
					"presentation_rect" : [ 1120.0, 511.0, 41.355469, 18.0 ],
					"text" : [ "_set $1" ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1120.0, 541.0, 60.666016, 19.0 ],
					"persistence" : 0,
					"presentation_rect" : [ 1120.0, 541.0, 60.666016, 19.0 ],
					"scope" : 0,
					"text" : "fmat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 10.0, 242.0, 1200.0, 245.0 ],
					"presentation_rect" : [ 15.0, 15.0, 1200.0, 245.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 313.5625, 620.0, 130.0, 20.0 ],
					"text" : "position (x,y,z)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 13.25, 620.0, 69.1875, 20.0 ],
					"text" : "mass index"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 135.0625, 590.0, 68.5, 20.0 ],
					"text" : "zl nth 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 82.4375, 620.0, 71.625, 18.0 ],
					"text" : "23"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 464.0, 560.0, 130.0, 20.0 ],
					"text" : "rotation (x,y,z)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 162.8125, 560.0, 70.0, 20.0 ],
					"text" : "mass index"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 285.5, 535.0, 68.5, 20.0 ],
					"text" : "zl nth 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 232.875, 560.0, 71.625, 18.0 ],
					"text" : "23"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 134.75, 510.0, 320.5, 20.0 ],
					"text" : "jcom.oscroute /massPositions /massRot"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 480.0, 100.0, 300.0, 105.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "@name", "jmod.moduleName", "@description", "A sonification model based on a Mass spring system" ],
					"bgmode" : 1,
					"id" : "obj-21",
					"maxclass" : "bpatcher",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 31.0, 34.0, 1200.0, 245.0 ],
									"presentation_rect" : [ 0.0, 0.0, 1200.0, 245.0 ]
								}
...
,
					"patching_rect" : [ 390.0, 255.0, 172.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 135.0, 140.0, 19.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 1200.5, 498.5, 1129.5, 498.5 ],
					"source" : [ "obj-7", 1 ]
				}
