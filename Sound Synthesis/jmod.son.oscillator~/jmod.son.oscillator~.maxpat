...
,
					"patching_rect" : [ 495.5, 441.0, 65.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 495.5, 480.0, 67.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 401.0, 358.0, 80.0, 4.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 162.0, 10.0, 80.0, 4.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 273.0, 359.0, 80.0, 4.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 162.0, 5.0, 80.0, 4.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 400.0, 331.0, 121.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 273.0, 331.0, 121.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 819.0, 255.0, 50.0, 17.0 ],
					"text" : "2"
				}
...
,
					"patching_rect" : [ 889.5, 197.0, 42.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
,
					"patching_rect" : [ 933.0, 247.0, 42.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 658.0, 90.0, 58.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 27.5, 58.0, 19.0 ],
					"text" : "voices nº"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1041.0, 217.0, 63.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 49.200012, 36.0, 19.0 ],
					"text" : "voice"
				}
...
,
					"patching_rect" : [ 933.0, 151.0, 103.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 933.0, 217.0, 100.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 69.0, 49.200012, 75.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 321.0, 197.0, 114.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 634.0, 175.5, 52.5, 19.0 ],
					"text" : "t l l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1145.5, 393.0, 59.0, 19.0 ],
					"text" : "jcom.thru"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 781.0, 78.0, 323.0, 43.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 933.0, 268.0, 270.0, 43.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1125.5, 468.0, 59.0, 19.0 ],
					"text" : "jcom.thru"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 718.5, 90.0, 50.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 69.0, 27.5, 38.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 634.0, 151.0, 114.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 644.5, 599.0, 41.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 74.0, 41.0, 19.0 ],
					"text" : "on/off"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 729.5, 599.0, 437.0, 19.0 ],
					"text" : "jcom.parameter.array 1 oscillator/onOff @type boolean @description \"toggle on/off \""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 695.5, 599.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 69.0, 74.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 149.0, 360.0, 50.0, 41.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 729.5, 441.0, 63.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 167.5, 27.5, 63.0, 19.0 ],
					"text" : "Wave form"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 729.5, 461.0, 100.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 236.0, 27.5, 54.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 684.5, 555.5, 40.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 236.0, 49.200012, 50.0, 19.0 ],
					"triangle" : 0,
					"triscale" : 0.9,
					"varname" : "freq"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 619.5, 555.5, 63.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 167.0, 49.200012, 63.0, 19.0 ],
					"text" : "Frequency",
					"varname" : "freq_c"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 62.0, 329.0, 48.0, 19.0 ],
					"text" : "jcom.in"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 729.5, 494.0, 435.0, 31.0 ],
					"text" : "jcom.parameter.array 1 oscillator/waveForm @type integer @repetitions/allow 1 @description \"choose  waveform - sine, triangle, saw, noise\""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 126.0, 470.0, 118.0, 19.0 ],
					"text" : "<- signal outputs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 729.5, 549.5, 540.0, 31.0 ],
					"text" : "jcom.parameter.array 1 oscillator/frequency @repetitions/allow 1 @type decimal @range/clipmode none @ramp/drive scheduler @ramp/function linear @description \"Set frequency\"",
					"varname" : "hue_angle"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 62.0, 393.0, 80.0, 19.0 ],
					"text" : "jcom.out~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 66.0, 465.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 62.0, 353.0, 107.0, 19.0 ],
					"text" : "jalg.son.oscillator~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 96.0, 465.0, 24.0, 24.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 1068.0, 355.5, 1155.0, 355.5 ],
					"source" : [ "obj-14", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 942.5, 323.0, 876.75, 323.0, 876.75, 194.0, 899.0, 194.0 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 677.0, 427.5, 1135.0, 427.5 ],
					"source" : [ "obj-50", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 942.5, 139.5, 643.5, 139.5 ],
					"source" : [ "obj-60", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 899.0, 218.0, 942.5, 218.0 ],
					"source" : [ "obj-91", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "/Users/joaomenezes/Documents/SonData/Sound Synthesis/jmod.son.oscillator~",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
