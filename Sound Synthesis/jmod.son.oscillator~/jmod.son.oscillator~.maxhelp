...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 32.0, 280.0, 300.0, 140.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 488.0, 215.0, 94.0, 31.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "@name", "jmod.son.oscillator~", "@description", "polyphonic oscillator" ],
					"bgmode" : 1,
					"id" : "obj-21",
					"maxclass" : "bpatcher",
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "jmod.son.oscillator~.maxpat",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "", "signal", "signal" ],
					"patching_rect" : [ 32.0, 165.0, 300.0, 105.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 32.0, 143.0, 140.0, 19.0 ],
...
, 			{
				"name" : "jmod.son.oscillator~.maxpat",
				"bootpath" : "/Users/joaomenezes/Documents/SonData_alpha/Sound Synthesis/jmod.son.oscillator~",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "jalg.son.oscillator~.maxpat",
				"bootpath" : "/Users/joaomenezes/Documents/SonData_alpha/Sound Synthesis/jmod.son.oscillator~",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
