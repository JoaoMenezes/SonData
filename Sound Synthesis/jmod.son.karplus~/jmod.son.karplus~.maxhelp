...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 280.0, 300.0, 140.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "@name", "jmod.son.karplus~", "@description", "Simple karplus strong using gen~" ],
					"bgmode" : 1,
					"id" : "obj-21",
					"maxclass" : "bpatcher",
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 0.0, 0.0, 803.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "jmod.son.karplus~.maxpat",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "", "signal", "signal" ],
					"patching_rect" : [ 30.0, 162.0, 300.0, 105.0 ],
...
,
					"patching_rect" : [ 410.0, 180.0, 172.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 140.0, 140.0, 19.0 ],
...
, 			{
				"name" : "jmod.son.karplus~.maxpat",
				"bootpath" : "/Users/joaomenezes/Documents/SonData_alpha/Sound Synthesis/jmod.son.karplus~",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
