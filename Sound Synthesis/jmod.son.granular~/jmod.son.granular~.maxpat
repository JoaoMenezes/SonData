...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 137.0, 756.0, 210.0, 55.0 ],
					"text" : "jcom.message state @type string @repetitions/allow 1 @description \" post the values of user controlled variables to the MAX window \""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 137.0, 820.0, 35.0, 17.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 137.0, 845.0, 239.0, 43.0 ],
					"text" : "jcom.message clear @type string @description \"impolitely clears the internal sample buffer\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 137.0, 735.0, 36.0, 17.0 ],
					"text" : "state"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 441.0, 222.0, 18.0, 20.0 ],
					"text" : "±",
					"varname" : "text_variation"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 92.0, 181.0, 103.0, 17.0 ],
									"text" : "script show param"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 133.0, 98.0, 17.0 ],
									"text" : "script hide param"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 50.0, 80.0, 46.0, 19.0 ],
									"text" : "sel 4 5"
								}
...
,
					"patching_rect" : [ 207.0, 654.0, 77.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 207.0, 676.0, 67.0, 19.0 ],
...
,
					"patching_rect" : [ 1003.5, 169.0, 42.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
,
					"patching_rect" : [ 1039.0, 220.0, 42.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
,
					"patching_rect" : [ 1039.0, 124.0, 103.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 421.0, 166.0, 114.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 740.0, 148.5, 52.5, 19.0 ],
					"text" : "t l l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1166.0, 322.0, 59.0, 19.0 ],
					"text" : "jcom.thru"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 740.0, 124.0, 114.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1039.0, 339.0, 59.0, 19.0 ],
					"text" : "jcom.thru"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 857.512512, 456.0, 308.0, 19.0 ],
					"text" : "set max de acordo com o valor do buffer em milisegundos",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 108.0, 310.0, 107.0, 19.0 ],
					"text" : "<- signal inputs ->"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 308.0, 51.0, 121.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 308.0, 8.0, 121.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 45.0, 438.0, 121.0, 19.0 ],
					"text" : "jcom.out~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "signal", "signal", "", "" ],
					"patching_rect" : [ 83.0, 340.0, 151.0, 19.0 ],
					"text" : "jcom.in~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 14.0, 222.0, 421.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 83.0, 310.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 218.0, 310.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 45.0, 375.0, 104.0, 19.0 ],
					"text" : "jalg.son.granular~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 96.0, 468.0, 24.0, 24.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 633.5, 404.0, 633.5, 404.0 ],
					"source" : [ "obj-22", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 430.5, 210.0, 23.5, 210.0 ],
					"source" : [ "obj-48", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 783.0, 339.75, 1048.5, 339.75 ],
					"source" : [ "obj-49", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 1048.5, 296.0, 999.75, 296.0, 999.75, 167.0, 1013.0, 167.0 ],
					"source" : [ "obj-50", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 180.5, 366.5, 456.5, 366.5 ],
					"source" : [ "obj-8", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 180.5, 364.0, 54.5, 364.0 ],
					"source" : [ "obj-8", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 1013.0, 191.0, 1048.5, 191.0 ],
					"source" : [ "obj-91", 0 ]
				}
