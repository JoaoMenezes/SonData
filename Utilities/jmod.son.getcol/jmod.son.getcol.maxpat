...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 582.0, 428.0, 454.0, 19.0 ],
					"text" : "jcom.return data @type array @repetitions/allow 1 @description \"return selected data \""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 308.0, 196.0, 5.0, 100.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 19.0, 39.5, 271.0, 5.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 635.0, 276.5, 150.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 184.5, 20.5, 40.0, 19.0 ],
					"text" : "Dump"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 600.75, 276.5, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 229.25, 20.5, 19.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 600.75, 311.0, 466.0, 19.0 ],
					"text" : "jcom.message dump @type none @repetitions/allow 1 @description \"dump selected data\""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 404.0, 435.5, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 142.75, 435.5, 144.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 15.5, 19.5, 89.0, 18.0 ],
					"text" : "Get column"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 142.75, 459.5, 138.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 15.5, 46.5, 59.0, 18.0 ],
					"text" : "Dataset"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 224.75, 534.5, 138.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 184.5, 46.5, 59.0, 18.0 ],
					"text" : "Column"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 600.75, 223.5, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 160.0, 46.5, 17.0, 17.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 600.75, 248.0, 496.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "clear" ],
					"patching_rect" : [ 174.25, 515.5, 51.0, 19.0 ],
					"text" : "t s clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "clear" ],
					"patching_rect" : [ 70.25, 435.5, 59.0, 19.0 ],
					"text" : "jcom.thru"
				}
...
, 			{
				"box" : 				{
					"annotation" : "Name of desired column",
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"id" : "obj-40",
					"items" : [ 0, ",", 1, ",", 2, ",", 3, ",", 4 ],
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 206.25, 551.0, 100.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 229.25, 46.5, 60.75, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 327.75, 551.0, 506.0, 19.0 ],
					"text" : "jcom.parameter column @type array @repetitions/allow 1 @description \"Name of desired column\""
				}

			}
, 			{
				"box" : 				{
					"annotation" : "Name of desired dataset",
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"id" : "obj-33",
					"items" : "<empty>",
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 133.75, 482.0, 100.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 64.0, 46.5, 91.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 242.25, 476.5, 510.0, 19.0 ],
					"text" : "jcom.parameter dataSet @type array @repetitions/allow 1 @description \"Name of desired dataset\""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 70.25, 398.0, 209.5, 19.0 ],
					"text" : "jalg.son.getcol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 70.25, 354.0, 56.0, 19.0 ],
					"text" : "jcom.in"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 13.0, 198.0, 520.0, 19.0 ],
					"text" : "jcom.hub @module_type control @description \"Get column from a desired Dataset (jmod.son.table)\"",
					"varname" : "jcom.hub"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 79.75, 462.25, 143.25, 462.25 ],
					"source" : [ "obj-60", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 79.75, 522.25, 215.75, 522.25 ],
					"source" : [ "obj-60", 0 ]
				}
...
, 			{
				"name" : "jalg.son.getcol.maxpat",
				"bootpath" : "/Users/joaomenezes/Documents/_Media_TECH/Code/GIT/SonData/SonData_Alpha/Utilities/jmod.son.getcol",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
