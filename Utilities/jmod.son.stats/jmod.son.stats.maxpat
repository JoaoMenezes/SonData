...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 621.0, 190.0, 70.0, 19.0 ],
					"text" : "jcom.return"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 135.0, 234.0, 22.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 455.0, 392.0, 77.0, 19.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 13.0, 50.5, 64.0, 31.0 ],
					"text" : "window size"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 438.0, 452.5, 64.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 13.0, 25.5, 64.0, 19.0 ],
					"text" : "windowed"
				}
...
, 			{
				"box" : 				{
					"annotation" : "flag indicating if calculations are windowed or run infinitively ",
					"id" : "obj-46",
					"maxclass" : "toggle",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 504.0, 452.5, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 93.0, 25.5, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 547.0, 429.0, 250.0, 55.0 ],
					"text" : "jcom.parameter windowed @type integer @repetitions/allow 0 @description \"flag indicating if calculations are windowed or run infinitively \""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 941.0, 124.0, 246.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 851.0, 124.0, 77.0, 19.0 ],
					"text" : "window_size:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 941.0, 104.0, 229.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 851.0, 104.0, 30.0, 19.0 ],
					"text" : "set:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 941.0, 84.0, 112.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 941.0, 64.0, 99.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 851.0, 64.0, 28.0, 19.0 ],
					"text" : "int:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 941.0, 44.0, 396.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 851.0, 44.0, 37.0, 19.0 ],
					"text" : "float:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 864.0, 289.0, 266.0, 19.0 ],
					"text" : "(default = 1)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 851.0, 199.0, 37.0, 19.0 ],
					"text" : "(int):"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 941.0, 199.0, 259.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 851.0, 179.0, 37.0, 19.0 ],
					"text" : "(int):"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 831.0, 234.0, 59.0, 19.0 ],
					"text" : "Attribute:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 831.0, 159.0, 113.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 831.0, 24.0, 42.0, 19.0 ],
					"text" : "Input:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 851.0, 254.0, 64.0, 19.0 ],
					"text" : "windowed:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 941.0, 179.0, 174.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 851.0, 84.0, 39.0, 19.0 ],
					"text" : "bang:"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 547.0, 361.0, 250.0, 43.0 ],
					"text" : "jcom.parameter windowSize @type integer @repetitions/allow 0 @description \"current window size\""
				}

			}
, 			{
				"box" : 				{
					"annotation" : "current window size",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
					"id" : "obj-19",
					"maxclass" : "number",
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 470.0, 373.0, 67.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 93.0, 50.5, 52.0, 19.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 547.0, 304.0, 250.0, 31.0 ],
					"text" : "jcom.message clear @type string @repetitions/allow 1 @description \"clear \""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 497.0, 317.0, 35.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 93.0, 78.5, 35.0, 17.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 77.0, 400.0, 22.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 77.0, 373.0, 55.0, 19.0 ],
					"text" : "jcom.out"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 11.0, 77.0, 150.0, 19.0 ],
									"text" : "BANG para trigar o cálculo\n"
								}
...
,
					"patching_rect" : [ 166.0, 343.0, 50.0, 19.0 ],
					"saved_object_attributes" : 					{
						"fontface" : 0,
						"fontsize" : 10.0,
						"tags" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 135.0, 289.0, 58.0, 19.0 ],
					"text" : "jcom.in 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 77.0, 343.0, 78.0, 19.0 ],
					"text" : "jalg.son.stats"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 13.0, 198.0, 492.0, 19.0 ],
					"text" : "jcom.hub @name stats @module_type control @description \"This module doesn't do much yet\"",
					"varname" : "jcom.hub"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 224.0, 343.0, 216.0, 17.0 ],
					"text" : "5 545"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"presentation" : 1,
					"presentation_rect" : [ 2.0, 2.0, 150.0, 105.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 164.0, 316.0, 86.5, 316.0 ],
					"source" : [ "obj-24", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 144.5, 327.5, 430.5, 327.5 ],
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "jalg.son.stats.maxpat",
				"bootpath" : "/Users/joaomenezes/Documents/_Media_TECH/Code/GIT/SonData/SonData_Alpha/Utilities/jmod.son.stats",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
