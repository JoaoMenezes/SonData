...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 836.0, 197.0, 49.0, 17.0 ],
					"text" : "process"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 604.0, 185.75, 157.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 75.44165, 45.0, 56.0, 19.0 ],
					"text" : "Process"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "clear" ],
					"patching_rect" : [ 388.5, 303.0, 42.0, 19.0 ],
					"text" : "t clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 388.5, 271.0, 54.0, 19.0 ],
					"text" : "jcom.init"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 594.5, 436.75, 157.0, 19.0 ],
					"text" : "string preview\n"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 62.0, 470.75, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 511.0, 239.0, 552.0, 19.0 ],
					"text" : "jcom.message string @type none @repetitions/allow 1 @description \"return list without the given element\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 601.0, 158.5, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 131.44165, 45.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 126.0, 350.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 457.44165, 340.5, 60.0, 19.0 ],
					"text" : "route text"
				}
...
, 			{
				"box" : 				{
					"annotation" : "type the undesired element",
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"id" : "obj-77",
					...
					"outlettype" : [ "", "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 457.44165, 303.0, 110.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 132.44165, 25.0, 125.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 457.44165, 381.5, 579.0, 19.0 ],
					"text" : "jcom.parameter undesiredElement @type string @repetitions/allow 1 @description \"type the undesired element\""
				}

			}
, 			{
				"box" : 				{
					"bgcolor" : [ 0.880342, 0.880342, 0.880342, 1.0 ],
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"id" : "obj-84",
					...
					"outlettype" : [ "", "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 461.5, 436.75, 133.0, 21.0 ],
					"readonly" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 455.0, 266.0, 157.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 19.44165, 25.0, 161.0, 19.0 ],
					"text" : "Undesired characters"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 62.0, 290.0, 48.0, 19.0 ],
					"text" : "jcom.in"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 62.0, 392.0, 87.0, 19.0 ],
					"text" : "jalg.son.except"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 398.0, 398.0, 471.0, 398.0 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "/Users/joaomenezes/Documents/_Media_TECH/Code/GIT/SonData/SonData_Alpha/Utilities/jmod.son.except",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
