...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 459.0, 252.5, 34.0, 19.0 ],
					"text" : "t 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 459.0, 224.0, 54.0, 19.0 ],
					"text" : "jcom.init"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 479.0, 479.0, 124.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 13.0, 76.0, 124.0, 19.0 ],
					"text" : "2012-07-25 14:05:53"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 479.0, 454.0, 70.0, 19.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 507.5, 378.0, 33.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 40.0, 24.0, 33.0, 19.0 ],
					"text" : "start"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 541.0, 378.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 13.0, 24.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 98.0, 248.0, 217.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 582.0, 286.5, 410.0, 19.0 ],
					"text" : "jcom.parameter mode @type string @repetitions/allow 1 @description \"modo \""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 474.0, 298.0, 100.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 13.0, 50.5, 124.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 11.0, 392.0, 98.0, 19.0 ],
					"text" : "jalg.son.datetime"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 582.0, 366.5, 204.0, 43.0 ],
					"text" : "jcom.parameter start @type boolean @repetitions/allow 1 @priority 2 @description \"start the clock\"",
					"varname" : "start"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 468.5, 358.0, 550.5, 358.0 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 20.5, 373.5, 140.5, 373.5 ],
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 20.5, 418.0, 488.5, 418.0 ],
					"source" : [ "obj-33", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 22.5, 236.5, 305.5, 236.5 ],
					"source" : [ "obj-37", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "/Users/joaomenezes/Documents/SonData/Utilities/jmod.son.datetime",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
